...
| MongoDB: 5 collections + data | ✅ orders, customers, menu_items, reviews, promotions | 32 documents total | 1.5 |
...
- **customers**: 6 in PostgreSQL (C001-C006), 5 in MongoDB (C007-C011)
- **menu_items**: 12 in PostgreSQL (M001-M012), 10 in MongoDB (M013-M022), different items
